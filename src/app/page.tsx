        ...
        <div className="container">
          ...
          <div className="lp-results-grid">
            {[
              ...
              { ic: "💬", t: "Un regard direct sur vos décisions", d: "Le retour franc de Max IA sur chacun de vos choix, pour avancer sans angle mort.", accent: "#8B5CF6" },
        ...
        <div className="container">
          ...
          <div className="lp-steps">
            {[
              ...
              { ic: "🤝", t: "Un retour personnalisé", d: "Max IA analyse ce que vous avez écrit et vous répond, pour décider juste.", accent: "#0D9488" },
            ].map((s) => (
          ...
          <div className="lp-about-grid reveal">
            ...
            <div className="lp-about-content">
              ...
              <p className="bio">
                ...
                sur ses méthodes et sa façon de penser : <strong>Max IA</strong>, son clone numérique,
