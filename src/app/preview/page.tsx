...
// Version de travail de la LP (v2). NON indexée : sert à valider avant bascule sur /.
...
export default function PreviewLanding() {
  ...
  return (
    <div className="lp">
      ...
      <div className="lp-flag">APERÇU v2 — page de validation (non publique). La LP en ligne n&apos;est pas modifiée.</div>
