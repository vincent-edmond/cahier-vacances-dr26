...
const SECTIONS: Section[] = [
  ...
  { tag: "1", title: "Ciblage", desc: "Le client idéal : celui qui achète plus, plus vite et plus souvent (la règle des 80/20).", qs: [
    ...
    { l: "Quels clients peu rentables ou qui vous prennent trop de temps arrêteriez-vous de servir ?", t: "area", ex: "Les petits chantiers ponctuels qui prennent autant de temps qu'un gros." },
    { l: "Si vous ne deviez viser qu'UN type de client pour les 12 prochains mois, lequel ?", t: "text", ex: "Les PME du bâtiment de 10 à 50 salariés." },
  ] },
  { tag: "2", title: "Acquisition", desc: "Un flux d'opportunités constant plutôt que des à-coups, canal par canal.", qs: [
    ...
    { l: "Vos nouveaux clients arrivent-ils de façon régulière, ou par à-coups ?", t: "choice", o: ["De façon régulière et prévisible", "Correct mais irrégulier", "Par à-coups, imprévisible"] },
  ...
  { tag: "3", title: "Conversion", desc: "Transformer l'intérêt en intention d'achat : colmater la fuite entre le premier contact et la décision.", qs: [
    { l: "Parmi les personnes intéressées (appel, message, devis), combien finissent par ne pas acheter ?", t: "choice", o: ["Peu (< 25 %)", "Environ la moitié", "Beaucoup (> 50 %)", "Je ne sais pas"], g: "c'est souvent par manque de relance ou de rapidité." },
    { l: "Relancez-vous les personnes intéressées qui n'ont pas encore acheté ?", t: "choice", o: ["Systématiquement", "Parfois", "Rarement ou jamais"] },
    { l: "Quand quelqu'un vous contacte, en combien de temps lui répondez-vous ?", t: "choice", o: ["Moins d'une heure", "Dans la journée", "Plusieurs jours"] },
    { l: "Avez-vous des étapes précises pour amener un client potentiel jusqu'à l'achat ?", t: "choice", o: ["Oui, un parcours structuré", "Informel", "Aucun"] },
  ] },
  ...
  { tag: "5", title: "Offre", desc: "L'offre irrésistible : rendre le « oui » évident, par la promesse, la gamme et la différenciation.", qs: [
    ...
    { l: "De 1 à 10, à quel point un client se dit « je serais fou de refuser » ?", t: "scale" },
    { l: "Qu'est-ce qui vous rend vraiment différent de vos concurrents ?", t: "area", ex: "Intervention sous 24 h garantie · SAV internalisé · 15 ans de références.", g: "du concret, pas « qualité » ni « sérieux »." },
    ...
    { l: "Quel changement (une garantie, un bonus, une nouvelle formule) rendrait votre offre irrésistible ?", t: "area", ex: "Ajouter une garantie résultat sous 90 jours." },
  ] },
  { tag: "6", title: "Profit", desc: "La mine d'or cachée dans vos clients actuels : panier moyen, fréquence, marge — transformer le volume en résultat net.", qs: [
    ...
    { l: "Entre le panier moyen et la fréquence d'achat, lequel pourriez-vous le plus augmenter ?", t: "choice", o: ["Panier moyen", "Fréquence d'achat"] },
    { l: "Où perdez-vous le plus de marge ?", t: "choice", o: ["Prix", "Coûts directs", "Masse salariale", "Remises", "Créances / impayés", "Stock"] },
  ] },
  { tag: "7", title: "Systems", desc: "La machine qui tourne sans vous : process documentés, indicateurs pilotés, organisation claire.", qs: [
    ...
    { l: "Celle qui vous prend le plus de temps : décrivez-la en 5 étapes", t: "area", ex: "1. Recevoir la demande · 2. Métrer · 3. Chiffrer · 4. Rédiger · 5. Envoyer et relancer." },
    ...
    { l: "Quel moment fixe bloquez-vous chaque semaine pour piloter votre entreprise ? (jour + heure)", t: "text", ex: "Vendredi 9 h – 11 h." },
  ] },
  ...
  { tag: "9", title: "Croissance", desc: "L'effet multiplicateur final : des clients ambassadeurs, une réputation qui précède l'entreprise, chaque levier qui renforce les huit autres.", qs: [
    ...
    { l: "Avez-vous un système pour obtenir des avis et des recommandations de vos clients ?", t: "choice", o: ["Oui, actif", "Informel", "Aucun"] },
