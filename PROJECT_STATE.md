...
- [ ] **Env Netlify à poser** : `SLACK_HELP_WEBHOOK_URL` (canal support), les 11 webhooks Setteo (`SETTEO_URL_OPTIN`, `SETTEO_URL_C1`…`C9`, `SETTEO_URL_PLAN`), et **`OPENAI_API_KEY`** (backup IA ; `OPENAI_MODEL` optionnel, défaut `gpt-4o`).
